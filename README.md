...
runpod-sdk = { version = "0.6", features = ["serverless"] }
```
...
runpod-sdk = { version = "0.6", features = [] }

# Alternative: native-tls
runpod-sdk = { version = "0.6", features = ["native-tls"], default-features = false }
```
...
```toml
runpod-sdk = { version = "0.6", features = ["tracing"] }
```
