...
use crate::RunpodClient;
#[cfg(feature = "serverless")]
use crate::serverless::{ServerlessEndpoint, ServerlessJob};
...
impl Endpoint {
    ...
    pub fn to_runner(&self, client: RunpodClient) -> ServerlessEndpoint {
        ServerlessEndpoint::new(&self.id, client)
    }
    ...
    /// # }
    /// ```
    pub fn run<I>(&self, client: RunpodClient, input: &I) -> crate::Result<ServerlessJob>
    where
        I: Serialize,
    {
